...
def get_month(y, m):
    ...
    if fcount:
        ...
        for i in range(fcount):
            if m != 1:
                month[0][i] = (n - (fcount - 1 - i), i, 0, m - 1, y)
            else:
                month[0][i] = (n - (fcount - 1 - i), i, 0, 12, y-1)
    ...
    if lcount:
        ...
        for i in range(lcount):
            if m != 12:
                month[-1][-lcount + i] = (n + i, 7 - lcount + i, 0, m + 1, y)
            else:
                month[-1][-lcount + i] = (n + i, 7 - lcount + i, 0, 1, y+1)
